		...
		<div id="left">
			...
			<div class="second_section first_col column-row-sec four trans left right_rounded padding_full" style="z-index:9999;position:relative;"> 
				...
				<div class="last_row row two_b padding_L"> 
					<h4 class="module_head">Firedogs tweet'n feed</h3>
					
					<?php
					$ch = curl_init();
					//curl_setopt($ch, CURLOPT_URL, "http://twitter.com/statuses/user_timeline/firedogdesign.rss");
					curl_setopt($ch, CURLOPT_URL, "http://twitter.com/statuses/user_timeline/firedogdesign.xml?count=1");
					...
					<h6 class="module_intro"><img src="<?php bloginfo('template_url');?>/images/arrow.png" height="15px" /><a href="http://twitter.com/firedogdesign" target="_blank">Follow the firedog</a></h6>     
				</div> 
			</div>
			<div class="clear"></div>
		</div>
